...
FixedDelayQueueImpl<Value, Rep, Period>::Element::Element(
        Value          value,
...
template<typename Value, typename Rep, typename Period>
FixedDelayQueueImpl<Value, Rep, Period>::FixedDelayQueueImpl(
        const Duration delay)
    : mutex{}
    , cond{}
    , queue{}
...
template<typename Value, typename Rep, typename Period>
void FixedDelayQueueImpl<Value, Rep, Period>::push(Value value)
{
...
template<typename Value, typename Rep, typename Period>
Value FixedDelayQueueImpl<Value, Rep, Period>::pop()
{
...
template<typename Value, typename Rep, typename Period>
size_t FixedDelayQueueImpl<Value, Rep, Period>::size() const noexcept
{
